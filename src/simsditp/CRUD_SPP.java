...
public class CRUD_SPP extends javax.swing.JFrame {
    ...
    private void BtnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnUpdateActionPerformed
        try {
            ...
            SQLConnection.doPreparedUpdate(sql, tahun, nominal, model.getValueAt(tbspp.getSelectedRow(),0));
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        try {
            ...
            SQLConnection.doPreparedUpdate(sql, model.getValueAt(tbspp.getSelectedRow(),0));
 ...
 private void tabelSpp() {
        ...
        try {
            String sql = "SELECT * FROM spp where tahun like '%?%' OR nominal LIKE '%?%'";
