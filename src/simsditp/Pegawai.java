...
public class Pegawai extends javax.swing.JPanel {
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        try {
            String query = "INSERT INTO pegawai (id_pegawai, nama_pegawai, jabatan, jenis_pegawai, nip) VALUES (?,?,?,?,?)";
    ...
    private void hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusActionPerformed
        ...
        if (barisTerpilih == -1) {
            ...
            int konfirmasi = JOptionPane.showConfirmDialog(null, "<html>Apakah Anda Akan Menghapus Data Pegawai <b>" + txtid1.getText() + "</b> <b>" + txtnama1.getText() + "</b></html>", "Konfirmasi Dialog", JOptionPane.YES_NO_OPTION);
    ...
    private void simpan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpan1ActionPerformed
        try {
            String query = "UPDATE pegawai SET id_pegawai=?,nama_pegawai=?,jabatan=?,jenis_pegawai=?,nip=? where id_pegawai=?";
            Boolean update = SQLConnection.doPreparedUpdate(
                    query, 
                    txtid1.getText(),
                    txtnama1.getText(),
                    cbjabatan1.getSelectedItem().toString(),
                    cbjenispegawai1.getSelectedItem().toString(),
                    txtnip1.getText(),
                    txtid1.getText()
            );
