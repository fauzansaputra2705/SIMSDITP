...
public class Mapel extends javax.swing.JPanel {
    ...
    private void hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusActionPerformed
        ...
        if (barisTerpilih == -1) {
            ...
            int konfirmasi = JOptionPane.showConfirmDialog(null, "<html>Apakah Anda Akan Menghapus Data Mapel <b>" + txtkode1.getText() + "</b> <b>" + cbmapel1.getSelectedItem() + "</b></html>", "Konfirmasi Dialog", JOptionPane.YES_NO_OPTION);
